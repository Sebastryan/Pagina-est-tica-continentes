...
foto1.addEventListener('click',()=>{
    imagenModal.src = "./galeria/img10.jpg";
    modaleGaleria.className = 'foto-mostrado';
})
foto2.addEventListener('click',()=>{
    imagenModal.src = "./galeria/img1.jpg";
    modaleGaleria.className = 'foto-mostrado';
})

foto3.addEventListener('click',()=>{
    imagenModal.src = "./galeria/img8.jpg";
    modaleGaleria.className = 'foto-mostrado';
})
foto4.addEventListener('click',()=>{
    imagenModal.src = "./galeria/img3.jpg";
    modaleGaleria.className = 'foto-mostrado';
})

foto5.addEventListener('click',()=>{
    imagenModal.src = "./galeria/img14.jpg";
    modaleGaleria.className = 'foto-mostrado';
})

foto6.addEventListener('click',()=>{
    imagenModal.src = "./galeria/img5.jpg";
    modaleGaleria.className = 'foto-mostrado';
})

foto7.addEventListener('click',()=>{
    imagenModal.src = "./galeria/img6.jpg";
    modaleGaleria.className = 'foto-mostrado';
})

foto8.addEventListener('click',()=>{
    imagenModal.src = "./galeria/img7.jpg";
    modaleGaleria.className = 'foto-mostrado';
})

foto9.addEventListener('click',()=>{
    imagenModal.src = "./galeria/img2.jpg";
    modaleGaleria.className = 'foto-mostrado';
})

foto10.addEventListener('click',()=>{
    imagenModal.src = "./galeria/img9.jpg";
    modaleGaleria.className = 'foto-mostrado';
})

foto11.addEventListener('click',()=>{
    imagenModal.src = "./galeria/img.jpg";
    modaleGaleria.className = 'foto-mostrado';
})

foto12.addEventListener('click',()=>{
    imagenModal.src = "./galeria/img11.jpg";
    modaleGaleria.className = 'foto-mostrado';
})

foto13.addEventListener('click',()=>{
    imagenModal.src = "./galeria/img12.jpg";
    modaleGaleria.className = 'foto-mostrado';
})

foto14.addEventListener('click',()=>{
    imagenModal.src = "./galeria/img13.jpg";
    modaleGaleria.className = 'foto-mostrado';
})

foto15.addEventListener('click',()=>{
    imagenModal.src = "./galeria/img4.jpg";
    modaleGaleria.className = 'foto-mostrado';
})
